...
self.searchItems = function(options, callback) {
	request("http://api.remix.bestbuy.com/v1/products(name="+options+"*)?show=name,salePrice,url,thumbnailImage&format=json&apiKey=npm62r3juru55gsxuggxyzbj", function (error, response, body) {
